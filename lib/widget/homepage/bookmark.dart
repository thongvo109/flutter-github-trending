...
class BookMarkRepo extends StatefulWidget {
  @override
  _BookMarkRepoState createState() => _BookMarkRepoState();
}

class _BookMarkRepoState extends State<BookMarkRepo> {
  StreamController _streamController = StreamController<List<GithubModel>>();
  List<GithubModel> _listRepo = List();
  @override
  void initState() {
    super.initState();
    GithubBaseApi().listBookmarks().then((listRepos) {
      _listRepo = listRepos;
